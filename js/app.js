(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".discounts__slider")) new core(".discounts__slider", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            autoHeight: true,
        ...
        if (document.querySelector(".inspiration__slider")) new core(".inspiration__slider", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            autoHeight: true,
            ...
            parallax: true,
            navigation: {
                prevEl: ".inspiration__slider .swiper-button-prev",
                nextEl: ".inspiration__slider .swiper-button-next"
            },
            pagination: {
                el: ".inspiration__slider .swiper-pagination",
                clickable: true
            },
            breakpoints: {
                320: {
        ...
        if (document.querySelector(".main-product__slider")) {
            ...
            new core(".main-product__slider", {
                modules: [ Navigation, Thumb ],
                navigation: {
                    prevEl: ".main-product__slider .swiper-button-prev",
                    nextEl: ".main-product__slider .swiper-button-next"
                },
                thumbs: {
                    swiper: thumbsSwiper
                },
        ...
        if (document.querySelector(".recommendation__slider")) new core(".recommendation__slider", {
            ...
            parallax: true,
            navigation: {
                prevEl: ".recommendation__slider .swiper-button-prev",
                nextEl: ".recommendation__slider .swiper-button-next"
            },
            pagination: {
                el: ".recommendation__slider .swiper-pagination",
                clickable: true
            },
            breakpoints: {
                320: {
    ...
    function documentActions() {
        const search = document.querySelector(".actions-header__form");
        document.addEventListener("click", menu);
        function menu(event) {
            if (event.target.closest(".form-search__button")) search.classList.toggle("_open");
            if (!event.target.closest(".actions-header__form")) search.classList.remove("_open");
        }
